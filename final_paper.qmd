...
```
So now that we have the average returns, we can calculate the CAPM alphas for each of the 7 factors, for both time periods.
...
Function to run CAPM ests and 7 factor regr. w Newey West SEs
```{r}
